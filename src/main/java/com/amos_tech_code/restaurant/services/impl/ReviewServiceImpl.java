...
import com.amos_tech_code.restaurant.exceptions.ReviewNotAllowedException;
import com.amos_tech_code.restaurant.repositories.RestaurantRepository;
import com.amos_tech_code.restaurant.services.ReviewService;
...
public class ReviewServiceImpl implements ReviewService {
    ...
    public Review createReview(User author, String restaurantId, ReviewCreateUpdateRequest review) {
        ...
        List<Photo> photos = review.getPhotoIds().stream().map(photoUrl -> Photo.builder()
                .url(photoUrl)
    ...
    public Review updateReview(User author, String restaurantId, String reviewId, ReviewCreateUpdateRequest review) {
        ...
        Review existingReview = getReviewFromRestaurant(reviewId, restaurant)
                .orElseThrow(() -> new RestaurantNotFoundException("Review does not exist."));
    ...
    private Restaurant getRestaurantorThrow(String restaurantId) {
        return restaurantRepository.findById(restaurantId)
                .orElseThrow(() ->
                        new RestaurantNotFoundException("Restaurant not found: " + restaurantId)
                );
    }
